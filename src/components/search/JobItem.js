            ...
            <div class="Row">
                ...
                <div clss="Column">
                    ...
                    <div>
                        ...
                        <button className='action-button' type="button" onClick={insertToFavorites.bind(this, 
                        ...
                        <button className='action-button' type="button" onClick={open.bind(this, listing.locationtext)}> Get Directions </button>
                    </div>
                </div>
                <br />
            </div>
